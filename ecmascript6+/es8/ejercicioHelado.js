...
const prepareIceCream = (money) => {
    return new Promise((resolve, reject) => {
        if(money >= 20) {    
            ...
            setTimeout(() => {
                resolve('Here you have a Chocolate Ice cream');
            }, 5000);  //3. Si el dinero que ingresaste es mayor o igual a 500, entonces te preparamos el helado. El proceso toma 6 segundos.
        } else {
...
buyIceCream(40); //1. llamas a la funcion comprar helado e Ingresas el dinero